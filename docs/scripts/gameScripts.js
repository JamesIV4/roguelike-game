...
(() => {
    ...
    const drawTitleScreen = () => {
        const background = document.querySelector('#display-wrapper'), uiElem = document.createElement('div'), titleContainer = document.createElement('div'), titleHeader = document.createElement('h1'), messageWindow = document.createElement('div'), buttonContainer = document.createElement('div'), btnStartGame = document.createElement('div'), btnLoadGame = document.createElement('div'), btnHighScores = document.createElement('div'), btnOptions = document.createElement('div');
        uiElem.id = 'ui-display';
        ...
        const handleOptions = (e) => {
            if (!e || e.type === 'click' || handleKeyboardConfirm(e)) {
                showMessageBox('<h2>Options</h2><p>Clear all saved game and high score data?</p>', [
                    {
